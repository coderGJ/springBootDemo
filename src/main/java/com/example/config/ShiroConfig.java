...
import com.example.security.CustomSessionDAO;
import com.example.security.CustomWebSessionManager;
import com.example.security.ShiroExceptionHandler;
...
//      shiroFilterFactoryBean.setUnauthorizedUrl("/403");
    ...
    public HashedCredentialsMatcher hashedCredentialsMatcher() {
        ...
        hashedCredentialsMatcher.setHashAlgorithmName(Sha256Hash.ALGORITHM_NAME);//散列算法:这里使用SHA-256算法;
